...
\begin{flalign}\label{gl:grundgl}
	\frac{dn}{dt}=0&=\dot{n}_0-\dot{n}+V_R*\sum \nu_{i,j}*r_j\\
	0&=\dot{n}_0-\dot{n}+V_R*R_i\\
\end{flalign}

\begin{flalign}
\dot{m}=	\frac{\SI{100 000}{\tonne\per\year}}{\SI{8000}{\tonne\per\year}}&= \SI{12,5}{\tonne\per\hour}\\
\dot{n}=\frac{\dot{m}}{M} = \frac{\SI{12500000}{\gram}}{\SI{82,03}{\gram\per\mole}}&=
