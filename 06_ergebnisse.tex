...
\end{flalign}
\textit{Im Folgenden wird die Reaktionsordnung n = 2  und eine Verweilzeit von $\tau=\SI{0,25}{\hour}$ angenommen. Als Reaktor wurde ein kontinuierlicher Rührkessel festgelegt.}
\begin{flalign}
