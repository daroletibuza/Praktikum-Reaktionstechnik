...
Aus den gemessenen Leitfähigkeiten des Versuchs "`Kinetik"' wurde der Umsatzgrad X(t) bestimmt \mbox{(siehe Gl. \ref{gl:1})}. Die Leitfähigkeit $\lambda_\infty$, wird zum Ende des Praktikums gemessen.
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Reaktionsgeschwindigkeit über dem Umsatzgrad für T=\SI{23,5}{\celsius}}
		\label{dia:r20}
	\end{center}
\end{figure}
\FloatBarrier
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Reaktionsgeschwindigkeit über dem Umsatzgrad für T=\SI{30,2}{\celsius}}
		\label{dia:r30}
	\end{center}
\end{figure}
\FloatBarrier
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Reaktionsgeschwindigkeit über dem Umsatzgrad für T=\SI{37,0}{\celsius}}
		\label{dia:r40}
	\end{center}
\end{figure}
\FloatBarrier
